...
function crearUsuario() {
   ...
   class Usuario{
      ...
      saludar() { //la clase usuario tiene un metodo llamadado saludar que devuelve un saludo personalizado.
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function() {
      return this.split("").reverse().join("") //split convierte la cadena en un array, join convierte el arrar de nuevo a cadena de caracteres
   }
}
